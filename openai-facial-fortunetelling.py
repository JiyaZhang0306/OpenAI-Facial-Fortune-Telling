...
def face_alignement(right_eyebrow, left_eyebrow):
    thresh = 15
    if len(right_eyebrow) < 2 or len(left_eyebrow) < 2:
        return False  # Alignment can't be determined

    if (right_eyebrow[1][1] < (left_eyebrow[1][1] + thresh) and 
        right_eyebrow[1][1] > (left_eyebrow[1][1] - thresh)):
        return True
    else:
        return False
...
# loop over the face detections
	for rect in rects:
		...
		print(f"Right Eyebrow: {right_eyebrow}")
		print(f"Left Eyebrow: {left_eyebrow}")
